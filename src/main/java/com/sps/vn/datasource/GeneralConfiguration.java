...
public class GeneralConfiguration {
	...
	public static class General {
		...
		public static final String TRANSACTION_MANAGER= "fgransactionManager";
	...
	public static class First {
		...
		public static final String ENTITY_PACKAGE= "com.sps.vn.entities.first";
	...
	public static class Second {
		...
		public static final String ENTITY_PACKAGE= "com.sps.vn.entities.second";
